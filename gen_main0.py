...
def main():
    ...
    parser.add_argument('--exp', type=str, default='user')
    ...
    parser.add_argument('--tab_enc', type=str, default='resnet')
    ...
    if args.id and not args.user:
        id_str = 'per'
    elif args.user and not args.id:
        id_str = 'gen'
    
    exp_name = f'{dataset_name}/{args.exp}/{mode}/{id_str}/fold_{fold}/seed_{seed}/'
